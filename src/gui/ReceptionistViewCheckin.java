...
public class ReceptionistViewCheckin extends JFrame {
	JPanel panelMain;
	...
	public ReceptionistViewCheckin() {
		setTitle("View Checkin Customers");
		...
		lblTitle = new JLabel("ALL CUSTOMER'S CHECK IN LIST");
...
//		obj[5] = "Credit Card";
	...
	public void refreshTable() {
		arrayCheckin = new NCbookJDBC().getCheckedIn();
		dtm.setRowCount(0);
