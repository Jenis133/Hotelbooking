...
//main class
public class CorporateDashboard extends JFrame implements ActionListener {
	// global variable
	int customerID;

	// declaration
	JPanel panelMain, panelTitle, panelLeft;
	JLabel btnClose, btnMinimize, btnMaximize;
	JLabel lblTitle, lblCustomer, img;
	JButton btnProfile, btnCBooking, btnInternalSercices, btnLogout, btnExit;

	// sub class
	public CorporateDashboard(int customerID) {

		this.customerID = customerID;

		// creating frame
		setTitle("Corporate Customer Dashboard");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setExtendedState(MAXIMIZED_BOTH); // window fully extended
		setLayout(null); // set layout null

		panelMain = new JPanel();
		panelMain.setBackground(new Color(211, 211, 211));
