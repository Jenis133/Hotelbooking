...
public class AddCustomers extends JFrame implements ActionListener {
	...
	JTabbedPane tPane;
	JLabel lblTitle1, lblTitle2, lblNcName, lblAddress, lblPhone, lblEmail, lblCredit, lblUsername, lblPassword,
			lblGender, lName, lAddress, lPhone, lEmail, lCompany, lUsername, lPassword, lblRetype1, lblRetype2;
	JTextField txtFName, txtLName, txtPw, txtAddress, txtPhone, txtEmail, txtCredit, txtUsername, tFName, tLName,
			tAddress, tPhone, tEmail, tCompany, tUsername;
	...
	public AddCustomers() {
		...
		lblRetype2.setBounds(10, 310, 150, 14);
		panel2.add(lblRetype2);

		pwdRetype2 = new JPasswordField();
		pwdRetype2.setBounds(129, 310, 288, 20);
